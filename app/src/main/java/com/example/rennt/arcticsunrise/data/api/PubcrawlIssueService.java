...
/**
 * The PubcrawlIssueService contains predefined network operations for use in Activities.
 *
 *
 ...
 *
 */
public class PubcrawlIssueService implements IssueService{
    ...
    public PubcrawlIssueService(DataModule.NetworkResolver resolver, Gson gson,
